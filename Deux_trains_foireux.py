...
T_2 = [0*i for i in range(75)] + [i*tau for i in range(75,N*(nb_ss-1))]
V_2 = [0*i for i in range(75)]
A_2 = [0*i for i in range(75)]
P_train_2 = [0*i for i in range(75)]

for e in range(nb_ss-2):
    V_2 += V_t
    A_2 += A_t
    P_train_2 += P_t_train

A_2 += [0*i for i in range(25)]
V_2 += [0*i for i in range(25)]
P_train_2 += [0*i for i in range(25)]
#print(len(A_2),len(V_2),len(P_train_2))
position = int(d_tot/2)
X_2 = [position for e in range(75)]
print(len(X_2))
for i in range(75, len(V_t)*(nb_ss-2)+75):
    position = position - V_2[i] * tau
    X_2.append(position)
print(len(X_2))

X_2 += [position for i in range(25)]
print(len(X_2))
